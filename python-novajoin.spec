...
install -p -D -m 644 %{buildroot}%{python3_sitelib}%{_sysconfdir}/novajoin/cloud-config-novajoin.json \
  %{buildroot}%{_sysconfdir}/novajoin/cloud-config-novajoin.json
install -p -D -m 644 %{buildroot}%{python3_sitelib}%{_sysconfdir}/novajoin/join-api-paste.ini \
  %{buildroot}%{_sysconfdir}/novajoin/join-api-paste.ini
install -p -D -m 755 %{buildroot}%{python3_sitelib}%{_libexecdir}/novajoin-ipa-setup \
  %{buildroot}%{_libexecdir}/novajoin-ipa-setup

# install data file
install -p -D -m 644 %{buildroot}%{python3_sitelib}%{_datadir}/freeipa.json \
  %{buildroot}%{_datadir}/freeipa.json
...
install -p -D -m 644 %{buildroot}%{python3_sitelib}%{_datarootdir}/novajoin/novajoin-notify.service \
  %{buildroot}%{_unitdir}/novajoin-notify.service
install -p -D -m 644 %{buildroot}%{python3_sitelib}%{_datarootdir}/novajoin/novajoin-server.service \
  %{buildroot}%{_unitdir}/novajoin-server.service
rm -f %{buildroot}%{python3_sitelib}%{_datarootdir}/novajoin/novajoin-notify.service
rm -f %{buildroot}%{python3_sitelib}%{_datarootdir}/novajoin/novajoin-server.service
