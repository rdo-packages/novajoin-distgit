...
# Install the upstream-provided unit files
install -p -D -m 644 %{_datarootdir}/novajoin/novajoin-notify.service \
  %{_unitdir}
install -p -D -m 644 %{_datarootdir}/novajoin/novajoin-server.service \
  %{_unitdir}
